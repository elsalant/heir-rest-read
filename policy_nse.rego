...
rule[{"action": {"name": "JoinAndRedact", "joinTable" : "Consent", "whereclause" : " WHERE consent.provision_provision_0_period_end >= observation.issued AND consent.provision_provision_0_period_start <= observation.issued", "joinStatement" : " JOIN consent ON observation.subject_reference = consent.patient_reference ", "columns": column_names}, "policy": description}]  {
    description := "Executes a JOIN on the Consent table"
#    input.resource.metadata.tags.observation
